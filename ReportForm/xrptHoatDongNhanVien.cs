...
{
    public partial class xrptHoatDongNhanVien : DevExpress.XtraReports.UI.XtraReport
    {
        public xrptHoatDongNhanVien(String manv, DateTime datefrom, DateTime dateto)
        {
            InitializeComponent();
